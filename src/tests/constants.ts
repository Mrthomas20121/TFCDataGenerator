...
export const TFCMetals: List<Metal> = List.from(
    new Metal(ResourceKey.of('tfc', 'bismuth'), 1, List.from(Type.PART), 0.14, 270),
    new Metal(ResourceKey.of('tfc', 'bismuth_bronze'), 2, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 985),
    new Metal(ResourceKey.of('tfc', 'black_bronze'), 2, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1070),
    new Metal(ResourceKey.of('tfc', 'brass'), 1, List.from(Type.PART), 0.35, 930),
    new Metal(ResourceKey.of('tfc', 'bronze'), 2, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 950),
    new Metal(ResourceKey.of('tfc', 'copper'), 1, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1080),
    new Metal(ResourceKey.of('tfc', 'gold'), 1, List.from(Type.PART), 0.6, 1060),
    new Metal(ResourceKey.of('tfc', 'nickel'), 1, List.from(Type.PART), 0.48, 1453),
    new Metal(ResourceKey.of('tfc', 'rose_gold'), 1, List.from(Type.PART), 0.35, 960),
    new Metal(ResourceKey.of('tfc', 'silver'), 1, List.from(Type.PART), 0.48, 961),
    new Metal(ResourceKey.of('tfc', 'tin'), 1, List.from(Type.PART), 0.14, 230),
    new Metal(ResourceKey.of('tfc', 'zinc'), 1, List.from(Type.PART), 0.21, 420),
    new Metal(ResourceKey.of('tfc', 'sterling_silver'), 1, List.from(Type.PART), 0.35, 900),
    new Metal(ResourceKey.of('tfc', 'wrought_iron'), 3, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1535),
    new Metal(ResourceKey.of('tfc', 'cast_iron'), 1, List.from(Type.PART), 0.35, 1535),
    new Metal(ResourceKey.of('tfc', 'pig_iron'), 3, new List(), 0.35, 1535),
    new Metal(ResourceKey.of('tfc', 'steel'), 4, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'black_steel'), 5, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1485),
    new Metal(ResourceKey.of('tfc', 'blue_steel'), 6, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'red_steel'), 6, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'weak_steel'), 4, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'weak_blue_steel'), 5, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'weak_red_steel'), 5, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'high_carbon_steel'), 3, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'high_carbon_black_steel'), 4, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'high_carbon_blue_steel'), 5, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'high_carbon_red_steel'), 5, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc', 'unknown'), 6, new List(), 0.35, 1540)
)

export const TFC_METALLUM_METALS: List<Metal> = List.from(
    new Metal(ResourceKey.of('tfc_metallum', 'antimony'), Tier.I, List.from(Type.PART), 0.14, 250),
    new Metal(ResourceKey.of('tfc_metallum', 'aluminum'), Tier.II, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1180),
    new Metal(ResourceKey.of('tfc_metallum', 'florentine_bronze'), Tier.III, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1000),
    new Metal(ResourceKey.of('tfc_metallum', 'boron'), Tier.II, List.from(Type.PART), 0.22, 575),
    new Metal(ResourceKey.of('tfc_metallum', 'ferroboron'), Tier.III, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1500),
    new Metal(ResourceKey.of('tfc_metallum', 'cobalt'), Tier.III, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1535),
    new Metal(ResourceKey.of('tfc_metallum', 'constantan'), Tier.II, List.from(Type.PART), 0.35, 1453),
    new Metal(ResourceKey.of('tfc_metallum', 'electrum'), Tier.II, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1060),
    new Metal(ResourceKey.of('tfc_metallum', 'invar'), Tier.III, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1330),
    new Metal(ResourceKey.of('tfc_metallum', 'lead'), Tier.II, List.from(Type.PART), 0.14, 328),
    new Metal(ResourceKey.of('tfc_metallum', 'britannium'), Tier.III, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.22, 850),
    new Metal(ResourceKey.of('tfc_metallum', 'purple_gold'), Tier.III, List.from(Type.PART), 0.35, 1060),
    new Metal(ResourceKey.of('tfc_metallum', 'iridium'), Tier.III, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1535),
    new Metal(ResourceKey.of('tfc_metallum', 'osmium'), Tier.III, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1535),
    new Metal(ResourceKey.of('tfc_metallum', 'osmiridium'), Tier.III, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1535),
    new Metal(ResourceKey.of('tfc_metallum', 'platinum'), Tier.V, List.from(Type.PART), 0.35, 1535),
    new Metal(ResourceKey.of('tfc_metallum', 'platine_steel'), Tier.VI, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1540),
    new Metal(ResourceKey.of('tfc_metallum', 'weak_platine_steel'), Tier.V, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc_metallum', 'titanium'), Tier.V, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1540),
    new Metal(ResourceKey.of('tfc_metallum', 'titan_steel'), Tier.VI, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1540),
    new Metal(ResourceKey.of('tfc_metallum', 'weak_titan_steel'), Tier.VI, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc_metallum', 'tungsten'), Tier.V, List.from(Type.PART), 0.35, 1540),
    new Metal(ResourceKey.of('tfc_metallum', 'tungsten_steel'), Tier.VI, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.35, 1540),
    new Metal(ResourceKey.of('tfc_metallum', 'weak_tungsten_steel'), Tier.VI, new List(), 0.35, 1540),
    new Metal(ResourceKey.of('tfc_metallum', 'uranium'), Tier.III, List.from(Type.PART), 0.35, 1500),
    new Metal(ResourceKey.of('tfc_metallum', 'pewter'), Tier.II, List.from(Type.PART, Type.TOOL, Type.ARMOR), 0.14, 270)
);
